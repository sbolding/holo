...
Mesh::Mesh(int dim, int number_elements, double width, MaterialConstant* material) //TODO currently constant material accross the problem
{
	...
	if (dim == 1)
	{
		...
		dirichlet_bcs.push_back(new DirichletBC1D(0, _elements[0], _nodes[0], 2.0));
		dirichlet_bcs.push_back(new DirichletBC1D(1, _elements[_n_elems-1], _nodes[_n_nodes-1], 0.50));
